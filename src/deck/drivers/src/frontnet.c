...
static float k = 1.0f;
static float maximal_speed = 1.2f; //1.0f;
static float maximal_angular_speed = 2.0f; //1.0f;
static float maximal_vertical_speed = 0.8f; //0.5f;
...
LOG_ADD(LOG_UINT8, control_enabled, &should_control)
