...
OPENOCD_TARGET    ?= target/stm32f4x.cfg#target/stm32f4x_stlink.cfg
...
PROJ_OBJ += ws2812_cf2_UP.o nvic_UP.o
else
PROJ_OBJ += ws2812_cf2.o nvic.o
endif

PROJ_OBJ += led_f405.o mpu6500.o i2cdev_f405.o lps25h.o i2c_drv.o
...
PROJ_OBJ += blinkM_led.o
PROJ_OBJ += statusLed.o
...
ifeq ($(DEBUG), 1)
  ...
  CFLAGS += -Os -DDISABLE_LIGHTHOUSE_DRIVER=1
